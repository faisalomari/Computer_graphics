...
bool Texture2D::loadTextureCube(const string& fileName, bool generateMipMaps)
{
	...
	unsigned char* data;
	imageData[0] = stbi_load("C://Users//omari//Desktop//posx.jpg", &width, &height, &components, 0);
	imageData[1] = stbi_load("C://Users//omari//Desktop//negx.jpg", &width, &height, &components, 0);
	imageData[2] = stbi_load("C://Users//omari//Desktop//posy.jpg", &width, &height, &components, 0);
	imageData[3] = stbi_load("C://Users//omari//Desktop//negy.jpg", &width, &height, &components, 0);
	imageData[4] = stbi_load("C://Users//omari//Desktop//posz.jpg", &width, &height, &components, 0);
	imageData[5] = stbi_load("C://Users//omari//Desktop//negz.jpg", &width, &height, &components, 0);
	...
	for (j; j < 6; j++)
	{
		...
		if (data) {
			...
			std::cout << "failed to load_cube" << j << std::endl;
			stbi_image_free(data);
		}
	}
